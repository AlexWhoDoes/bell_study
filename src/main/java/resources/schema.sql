CREATE TABLE IF NOT EXISTS Organization (
    ...
    name       VARCHAR(50)   NOT NULL          COMMENT 'Short name of an organization',
...
CREATE TABLE IF NOT EXISTS Office (
    id              INTEGER                    COMMENT 'Unique identifier' PRIMARY KEY AUTO_INCREMENT,
    name            VARCHAR(50)   NOT NULL     COMMENT 'Short name of an organization office',
...
CREATE INDEX IX_User_id ON User (first_name);
...
CREATE TABLE IF NOT EXISTS Citizenship (
    ...
    name           VARCHAR(50)   NOT NULL       COMMENT 'Citizenship name'
);
...
CREATE TABLE IF NOT EXISTS Document (
     ...
     date            DATE        NOT NULL        COMMENT 'Real document date'
);
